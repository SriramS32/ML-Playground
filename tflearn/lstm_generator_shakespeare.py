...
import tflearn
from tflearn.data_utils import random_sequence_from_textfile, textfile_to_semi_redundant_sequences
...
m = tflearn.SequenceGenerator(g, dictionary=char_idx, seq_maxlen=maxlen, clip_gradients=5.0, checkpoint_path='model_shakespeare')
